...
class ThemeColor {
  ...
  //main page
  Color get mainBackColor => _isLight ? Color.fromRGBO(255,247,250, 1.0) : Color.fromRGBO(51, 51, 51, 1.0);
  Color get mainForeColor => _isLight ? Color.fromRGBO(85, 85, 85, 1.0) : Color.fromRGBO(255, 255, 255, 0.7);
  Color get mainButtonBackColor => _isLight ? Color.fromRGBO(71, 64, 120, 1.0) : Color.fromRGBO(71, 64, 120, 1.0);
  Color get mainButtonForeColor => _isLight ? Color.fromRGBO(238, 238, 238, 1.0) : Color.fromRGBO(238, 238, 238, 1.0);
  //setting page
