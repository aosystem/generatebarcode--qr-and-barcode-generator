...
import 'package:generatebarcode/ad_ump_status.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  void _initState() async {
    ...
    _defaultBarcodeIndex = Model.barcodeOptionIndex;
  ...
  Future<void> _onApply() async {
    await Model.setBarcodeOptionIndex(_defaultBarcodeIndex);
  ...
  Widget _buildDefaultBarcodeType(AppLocalizations l) {
    if (barcodeOptions.isEmpty) {
      return const SizedBox.shrink();
    }
    final TextTheme t = Theme.of(context).textTheme;
    final int selectedIndex =
    _defaultBarcodeIndex.clamp(0, barcodeOptions.length - 1).toInt();
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Expanded(
              child: Text(l.defaultBarcodeType, style: t.bodyMedium),
            ),
            ...
            DropdownButton<int>(
              ...
              items: List.generate(
                barcodeOptions.length,
                  ...
                  value: index,
                  child: Text(barcodeOptions[index].label),
                ),
              ),
              onChanged: (value) {
                if (value != null) {
                  setState(() {
                    _defaultBarcodeIndex = value;
                  });
                }
              },
            ),
